...
ansur_rf_model = grid_cost_pipeline.fit(X_train, y_train)

ansur_deploy_model = RandomForestClassifier(n_estimators = ansur_rf_model.best_params_['rf__n_estimators'],
                                        max_features = ansur_rf_model.best_params_['rf__max_features'],
                                        max_depth    = ansur_rf_model.best_params_['rf__max_depth']).fit(X_train, y_train)
